...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h5 style="min-height: 90px;">${product.title}</h5> 

      <h6>Rating: <span class="text-warning"><i class="fas fa-star"></i> ${product.rating.rate}</span> </h6>

      <h6>Feedback: <i class="fas fa-user text-success"></i> <span class="text-warning text-bold" >${product.rating.count}</span></h6>
